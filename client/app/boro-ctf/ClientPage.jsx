...
export default function BoroCtfClient({ writeups }) {
    useEffect( () => {
        (
            async () => {
        ...
        <main className={styles.main}>
            ...
            <div className={styles.pageContent}>
                <section className={styles.hero}>
                    <motion.h1 variants={slideUp} initial="initial" animate="enter">boroCTF</motion.h1>
                ...
                <section className={styles.content}>
                    <div className={styles.writeupsList}>
                        {writeups.map((writeup, index) => (
                            <Link href={`/boro-ctf/${writeup.slug}`} key={index} className={styles.writeupRowLink}>
